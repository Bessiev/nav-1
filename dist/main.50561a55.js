...
var xObject = JSON.parse(x); //将字符串重新变为对象

var hashMap = xObject || [//第一次xObject是空的
{ logo: 'A', url: 'https://www.acfun.cn' }, { logo: 'B', url: 'https://www.bilibili.com' }];
var simplifyUrl = function simplifyUrl(url) {
    return url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); // 删除 / 开头的内容，利用正则表达式，.*表示后面的所有内容
};
...
window.onbeforeunload = function () {
    var string = JSON.stringify(hashMap); //将对象变成字符串
...
//# sourceMappingURL=main.50561a55.map